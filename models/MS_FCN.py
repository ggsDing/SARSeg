# An implementation of the model in "Polsar image semantic segmentation based on deep transfer learning—realizing smooth classification with small training sets”
